...
type RegisterRequest struct {
	Username string `thrift:"username,1,required" json:"username,required" query:"username,required" vd:"len($) >= 5 && len($) <= 25"`
	Password string `thrift:"password,2,required" json:"password,required" query:"password,required" vd:"len($) >= 8 && len($) <= 25"`
}
...
type UserService interface {
	Register(ctx context.Context, request *RegisterRequest) (r *base.NilResponse, err error)

	Login(ctx context.Context, request *LoginRequest) (r *base.NilResponse, err error)
}
...
func (p *UserServiceClient) Register(ctx context.Context, request *RegisterRequest) (r *base.NilResponse, err error) {
...
func (p *UserServiceClient) Login(ctx context.Context, request *LoginRequest) (r *base.NilResponse, err error) {
